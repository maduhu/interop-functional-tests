...
public class USSDFunctionalTests {
...
//        url = "http://localhost:8081";
        ...
        writer = new FileWriter("target/failure-reports/ussd.html");
	 ...
	 * 
	 */
	@Test(groups={"usssd_end_to_end"})
	public void test_positive_ussd_end_to_end() {
